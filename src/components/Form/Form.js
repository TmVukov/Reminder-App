  ...
  return (
    <div className="form__container">
      ...
      <form className="form">
        ...
        {title.length === 30 && (
          <p className="form__title-msg">
            Sorry, allowed title length is 30 characters.
          </p>
        )}
        ...
        {description.length === 200 && (
          <p className="form__description-msg">
            Sorry, allowed description length is 200 characters.
          </p>
        )}
      </form>

      <button className="form__btn-color" onClick={() => setOpen(!open)}>
        Select color
      </button>
